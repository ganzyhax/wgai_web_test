...
final Map<String, dynamic> myIconMap = {
  ...
  "currencyKzt": PhosphorIcons.currencyKzt((PhosphorIconsStyle.regular)),
  "globe": PhosphorIcons.globe((PhosphorIconsStyle.regular)),
  "heartbeat": PhosphorIcons.heartbeat((PhosphorIconsStyle.regular)),
  "mapPinLine": PhosphorIcons.mapPinLine((PhosphorIconsStyle.regular)),
  ...
  "monitorPlay": PhosphorIcons.monitorPlay((PhosphorIconsStyle.regular)),
